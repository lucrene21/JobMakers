                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        ...
                        <div class="card m-auto border">
                            ...
                            <div class="card-body">
                                <h5 class="card-title"><b>Reference:</b>{{ $payment->reference}}</h5>
                            </div>
                            <div class="card-body">
                                @if(isset($payment_methods) && count($payment_methods) > 0)
                                    @foreach($payment_methods as $key => $payment_method)
                                <h5 class="card-title"><b>Payment Method:</b>{{ $payment_method->label}}</h5>
                                    @endforeach
                                 @endif
                            </div>
                            <div class="card-body">
                            ...
                            <div class="card-body">
                                @if(isset($orders) && count($orders) > 0)
                                    @foreach($orders as $key => $order)
                                        <h5 class="card-title"><b>Starting Date:</b>{{ $order->started_at}}</h5>
                                        <h5 class="card-title"><b>Ending Date:</b>{{ $order->ended_at}}</h5>
                                        <h5 class="card-title"><b>state:</b>{{ $order->state}}</h5>
                                        <p class="card-text">  </p>
                                    @endforeach
                                @endif
                            </div>

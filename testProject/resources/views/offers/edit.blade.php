                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 ml-auto mr-auto">
                            <div class="card p-4 rounded-plus bg-faded">
                                <form id="js-login" novalidate="" method="POST" action="{{ route('offers.update', $offer->id) }}">
                                    @csrf
                                    @method('put')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="label" class="form-control @error('label') is-invalid @enderror"
                                               name="label" value="{{ $offer->label }}"  required placeholder="Edit label"/>
                                        @error('label')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="description" class="form-control @error('description') is-invalid @enderror" name="description"
                                               value="{{ $offer->description }}" required placeholder="Enter a description">
                                        @error('description')
                                        <span class="invalid-feedback" role="alert">
                                               <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="numeric" id="price_min" class="form-control @error('price_min') is-invalid @enderror" name="price_min"
                                               value="{{ $offer->price_min }}" required placeholder="Enter min price">
                                        @error('price_min')
                                        <span class="invalid-feedback" role="alert">
                                               <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="numeric" id="price_max" class="form-control @error('price_max') is-invalid @enderror" name="price_max"
                                               value="{{ $offer->price_max }}" required placeholder="Enter max price">
                                        @error('price_min')
                                        <span class="invalid-feedback" role="alert">
                                               <strong>{{ $message }}</strong>
                                        </span>

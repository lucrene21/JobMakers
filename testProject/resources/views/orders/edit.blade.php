                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 ml-auto mr-auto">
                            <div class="card p-4 rounded-plus bg-faded">
                                <form id="js-login" novalidate="" method="POST" action="{{ route('orders.update', $order->id) }}">
...
{{--                                    </div>--}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="numeric" id="price" class="form-control @error('price') is-invalid @enderror" name="price"
                                               value="{{ $order->price }}" required placeholder="Enter min price">
                                        @error('price')
                                        <span class="invalid-feedback" role="alert">
                                               <strong>{{ $message }}</strong>
                                        </span>

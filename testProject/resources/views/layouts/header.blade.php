...
<div class="search">
    <form class="app-forms hidden-xs-down" role="search"
          action="https://www.gotbootstrap.com/themes/smartadmin/4.0.2/page_search.html" autocomplete="off">
        <input type="text" id="search-field" placeholder="Search for anything" class="form-control" tabindex="1">
        <a href="#" onclick="return false;" class="btn-danger btn-search-close js-waves-off d-none" data-action="toggle"
...
<div class="ml-auto d-flex">
    ...
    <div>
        <a href="#" class="header-icon" data-toggle="dropdown" title="You got 11 notifications">
            ...
            @if(Auth::User()->countReadMessage() > 0)
        ...
        <div class="dropdown-menu dropdown-menu-animated dropdown-xl">
            <div
                ...
                <h4 class="m-0 text-center color-white">
                    {{ Auth::User()->countReadMessage() }} New
                            ...
                            <li class="unread">
                                <a href="#" class="d-flex align-items-center">
                                    ...
                                    <span class="d-flex flex-column flex-1 ml-1">
                                        ...
                                        <span class="fs-nano text-muted mt-1">{{ $message->created_at->diffForHumans() }}</span>
                                    </span>
                                </a>
                            </li>
                        @endforeach
        ...
        <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
            <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                                            <span class="mr-2">
                                                <img src="{{asset('theme')}}/img/demo/avatars/avatar-m.png"
                                                     class="rounded-circle profile-image" alt="Dr. Codex Lantern">
                                            </span>
                    <div class="info-card-text">
                        <div
                            class="fs-lg text-truncate text-truncate-lg">{{ Auth::user()->first_name .' '. Auth::user()->last_name }}</div>
                        <span
                            class="text-truncate text-truncate-md opacity-80 text-uppercase">{{ Auth::user()->role->label }}</span>
                    </div>
                </div>
            </div>
